...
# CUDA_VISIBLE_DEVICES=2 nohup vllm serve /tf/orion.zou/repos/SimPO/outputs/llama-3-8b-instruct-simpo-aflow-3 --dtype auto --api-key token-abc123 --port 8085 --host 0.0.0.0 --gpu_memory_utilization 0.95  --seed 1234   > vllm_serving.log 2>&1 &
