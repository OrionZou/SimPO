...
CUDA_VISIBLE_DEVICES=3,4 nohup accelerate launch --config_file accelerate_configs/deepspeed_zero3.yaml --main_process_port 29501 --num_processes 2 scripts/run_simpo.py training_configs/llama-3-8b-instruct-simpo-codeUltrafeedback.yaml  > llama-3-8b-instruct-simpo-codeUltrafeedback.log 2>&1 &
