...
# CUDA_VISIBLE_DEVICES=4,5 nohup accelerate launch --config_file accelerate_configs/deepspeed_zero3.yaml --main_process_port 29501 --num_processes 2 scripts/run_simpo.py training_configs/llama-3-8b-instruct-simpo-aflow_v6.yaml  > llama-3-8b-instruct-simpo-alow-6.log 2>&1 &
export PYTORCH_CUDA_ALLOC_CONF="expandable_segments:True"
# CUDA_VISIBLE_DEVICES=3,4 nohup accelerate launch --config_file accelerate_configs/deepspeed_zero3.yaml --main_process_port 29501 --num_processes 2 scripts/run_simpo.py training_configs/llama-3-8b-instruct-simpo-aflow_v3_2_onlycot.yaml  > llama-3-8b-instruct-simpo-alow-3-onlycot.log 2>&1 &
# CUDA_VISIBLE_DEVICES=3,4 nohup accelerate launch --config_file accelerate_configs/deepspeed_zero3.yaml --main_process_port 29501 --num_processes 2 scripts/run_simpo.py training_configs/llama-3-8b-instruct-simpo-aflow_v3_2_graph_cot.yaml  > llama-3-8b-instruct-simpo-alow-3-graph+cot.log 2>&1 &
# CUDA_VISIBLE_DEVICES=6,7 nohup accelerate launch --config_file accelerate_configs/deepspeed_zero3.yaml --main_process_port 29502 --num_processes 2 scripts/run_simpo.py training_configs/llama-3-8b-instruct-simpo-aflow_v5.yaml  > llama-3-8b-instruct-simpo-alow-5.log 2>&1 &
# CUDA_VISIBLE_DEVICES=4,5 nohup accelerate launch --config_file accelerate_configs/deepspeed_zero3.yaml --main_process_port 29501 --num_processes 2 scripts/run_simpo.py training_configs/llama-3-8b-instruct-simpo-aflow_v7.yaml  > llama-3-8b-instruct-simpo-alow-7.log 2>&1 &
...
wandb sync /tf/orion.zou/repos/SimPO/wandb/offline-run-20250218_151113-go8fsdnw
